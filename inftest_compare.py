...
def inf_plot_compare(alpha_vec, prob, prob_lo, prob_hi, title=None,savename='convergence_compare.pdf'):
...
def Inf_test_compare(mcmcfile1,mcmcfile2, reweight=False, marginalize=False, astro_params_ngauss=8, seed_or_rng=None, cornerprefix=None,savename='convergence_test.pdf'):
    ...
    mcmc_results = h5py.File(mcmcfile1, 'r')
...
if __name__ == "__main__":
    ...
    Inf_test_compare(mcmc_outfile, reweight=False, cornerprefix=cornerprefix, seed_or_rng=seed_or_rng)
